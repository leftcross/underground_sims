...
// ********************************************************************
//
/// \file src/RE01TrackInformation.cc
/// \brief Implementation of the TrackInformation class for DAMIC 
//
//
// 
// originally from a Geant4 example, modified for DAMIC by M.S. 
//
...
G4ThreadLocal G4Allocator<DAMICTrackInformation> *
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
DAMICTrackInformation::DAMICTrackInformation(const G4Track* aTrack)
  : G4VUserTrackInformation()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
DAMICTrackInformation& DAMICTrackInformation
::operator =(const DAMICTrackInformation& aTrackInfo)
{
    fOriginalTrackID = aTrackInfo.fOriginalTrackID;
    fParticleDefinition = aTrackInfo.fParticleDefinition;
    fOriginalPosition = aTrackInfo.fOriginalPosition;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void DAMICTrackInformation::SetSourceTrackInformation(const G4Track* aTrack)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void DAMICTrackInformation::Print() const
{
    G4cout 
