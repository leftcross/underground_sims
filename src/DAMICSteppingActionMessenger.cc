...
DAMICSteppingActionMessenger::DAMICSteppingActionMessenger
   (DAMICSteppingAction* SA):steppingAction(SA) {

  colourNeutronCmd = new G4UIcmdWithAString("/damic/draw/neutronColour",this);
  ...
  colourGammaCmd = new G4UIcmdWithAString("/damic/draw/gammaColour",this);
  ...
  colourOpticalCmd = new G4UIcmdWithAString("/damic/draw/opticalColour",this);
  ...
  colourChargedPlusCmd = new G4UIcmdWithAString("/damic/draw/chargedplusColour",this);
  ...
  colourChargedMinusCmd = new G4UIcmdWithAString("/damic/draw/chargedminusColour",this);
...
//ooooooooooooooooooooooooooooooooooooooooo
void DAMICSteppingActionMessenger::SetNewValue(G4UIcommand* command, 
  G4String newValue) {
