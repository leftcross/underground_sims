...
// ********************************************************************
//
/// \file runAndEvent/DAMIC/include/DAMICTrackInformation.hh
/// \brief Definition of the DAMICTrackInformation class
//
//
// $Id: DAMICTrackInformation.hh 97671 2016-06-07 08:25:00Z gcosmo $
//
...
public:
  ...
  DAMICTrackInformation(const G4Track* aTrack);
  DAMICTrackInformation(const DAMICTrackInformation* aTrackInfo);
  virtual ~DAMICTrackInformation();
   
  inline void *operator new(size_t);
  inline void operator delete(void *aTrackInfo);

  DAMICTrackInformation& operator =(const DAMICTrackInformation& right);
...
extern G4ThreadLocal
 G4Allocator<DAMICTrackInformation> * aTrackInformationAllocator;

inline void* DAMICTrackInformation::operator new(size_t)
{
  if(!aTrackInformationAllocator)
    aTrackInformationAllocator = new G4Allocator<DAMICTrackInformation>;
  return (void*)aTrackInformationAllocator->MallocSingle();
}

inline void DAMICTrackInformation::operator delete(void *aTrackInfo)
{ aTrackInformationAllocator->FreeSingle((DAMICTrackInformation*)aTrackInfo);}
