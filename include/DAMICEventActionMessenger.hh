...
#ifndef DAMICEventActionMessenger_h
#define DAMICEventActionMessenger_h 1
...
class DAMICEventActionMessenger: public G4UImessenger {

  public:
    DAMICEventActionMessenger(DAMICEventAction*);
   ~DAMICEventActionMessenger();
    
  void SetNewValue(G4UIcommand*, G4String);
    
  private:
    DAMICEventAction*     eventAction;   
  
    G4UIdirectory*        damicDirectory;
    ...
    G4UIcmdWithABool* cosmicNeutronsCmd;
};
