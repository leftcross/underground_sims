...
G4LogicalVolume* GetConstructionAncientLead1()
{
  ...
  G4LogicalVolume * ancientLead1 = new G4LogicalVolume(cylLead, LeadMat,"AncientLead1");
...
G4LogicalVolume* GetConstructionGoodLead()
{
  ...
  G4Material* Lead = G4Material::GetMaterial("G4_Pb");
  G4LogicalVolume * goodLead = new G4LogicalVolume(goodLeadFinal, LeadMat,"GoodLead");
